...
if ($ADMIN->fulltree) {
    ...
    $settings->add(new admin_setting_heading(
        'report_studentgrades/colorheading',
    ...
    $settings->add(new admin_setting_configcolourpicker(
        'report_studentgrades/header_primary_color',
    ...
    $settings->add(new admin_setting_configcolourpicker(
        'report_studentgrades/header_secondary_color',
    ...
    $settings->add(new admin_setting_configcolourpicker(
        'report_studentgrades/header_text_color',
    ...
    $settings->add(new admin_setting_configcolourpicker(
        'report_studentgrades/grade_excellent_color',
    ...
    $settings->add(new admin_setting_configcolourpicker(
        'report_studentgrades/grade_good_color',
    ...
    $settings->add(new admin_setting_configcolourpicker(
        'report_studentgrades/grade_average_color',
    ...
    $settings->add(new admin_setting_configcolourpicker(
        'report_studentgrades/grade_poor_color',
    ...
    $settings->add(new admin_setting_configcolourpicker(
        'report_studentgrades/table_border_color',
    ...
    $settings->add(new admin_setting_configcolourpicker(
        'report_studentgrades/row_alternate_color',
    ...
    $settings->add(new admin_setting_configcolourpicker(
        'report_studentgrades/row_hover_color',
    ...
    // Category Colors
    $settings->add(new admin_setting_configcolourpicker(
        'report_studentgrades/category_primary_color',
    ...
    $settings->add(new admin_setting_configcolourpicker(
        'report_studentgrades/category_secondary_color',
    ...
    // Total Row Colors
    $settings->add(new admin_setting_configcolourpicker(
        'report_studentgrades/category_total_primary_color',
    ...
    $settings->add(new admin_setting_configcolourpicker(
        'report_studentgrades/category_total_secondary_color',
    ...
    $settings->add(new admin_setting_configcolourpicker(
        'report_studentgrades/course_total_primary_color',
    ...
    $settings->add(new admin_setting_configcolourpicker(
        'report_studentgrades/course_total_secondary_color',
    ...
    $settings->add(new admin_setting_configcolourpicker(
        'report_studentgrades/grade_value_color',
    ...
    $settings->add(new admin_setting_configcolourpicker(
        'report_studentgrades/grade_value_bg_color',
    ...
    $settings->add(new admin_setting_configcolourpicker(
        'report_studentgrades/percentage_color',
    ...
    $settings->add(new admin_setting_configcolourpicker(
        'report_studentgrades/percentage_bg_color',
    ...
    // AI Settings
    $settings->add(new admin_setting_heading(
        'report_studentgrades/aisettings',
        get_string('aisettings', 'report_studentgrades'),
    ...
    $defaultprompt = get_string('defaultprompt', 'report_studentgrades');

    $settings->add(new admin_setting_configtextarea(
        'report_studentgrades/aiprompt',
        get_string('aiprompt', 'report_studentgrades'),
        get_string('aipromptdesc', 'report_studentgrades'),
        $defaultprompt,
        PARAM_RAW
    ));

    $settings->add(new admin_setting_configtext(
        'report_studentgrades/aicooldown',
        get_string('aicooldown', 'report_studentgrades'),
        get_string('aicooldowndesc', 'report_studentgrades'),
        0,
        PARAM_INT
    ));
    ...
    $settings->add(new admin_setting_heading(
        'report_studentgrades/resetheading',
